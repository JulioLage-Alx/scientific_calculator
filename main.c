...
void display(){
    float *num_arr = (float*)malloc(256 * sizeof(float)); //Alocando um espaco da memoria para o array de floats
    char *op_arr = (char*)malloc(256 * sizeof(char)); //Alocando um espaco da memoria para o array de operacoes
